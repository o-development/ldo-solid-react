[ldo-solid-react](../README.md) / [Exports](../modules.md) / FetchableDocument

# Class: FetchableDocument
...
- [constructor](FetchableDocument.md#constructor)

### Properties

- [\_didInitialFetch](FetchableDocument.md#_didinitialfetch)
- [\_error](FetchableDocument.md#_error)
- [\_isLoading](FetchableDocument.md#_isloading)
- [\_isWriting](FetchableDocument.md#_iswriting)
- [dependencies](FetchableDocument.md#dependencies)
- [captureRejectionSymbol](FetchableDocument.md#capturerejectionsymbol)
- [captureRejections](FetchableDocument.md#capturerejections)
- [defaultMaxListeners](FetchableDocument.md#defaultmaxlisteners)
- [errorMonitor](FetchableDocument.md#errormonitor)

### Accessors

- [didInitialFetch](FetchableDocument.md#didinitialfetch)
- [error](FetchableDocument.md#error)
- [isLoading](FetchableDocument.md#isloading)
- [isWriting](FetchableDocument.md#iswriting)
- [onDocumentError](FetchableDocument.md#ondocumenterror)

### Methods

- [addListener](FetchableDocument.md#addlistener)
- [beginWrite](FetchableDocument.md#beginwrite)
- [emit](FetchableDocument.md#emit)
- [emitStateUpdate](FetchableDocument.md#emitstateupdate)
- [endWrite](FetchableDocument.md#endwrite)
- [eventNames](FetchableDocument.md#eventnames)
- [fetchDocument](FetchableDocument.md#fetchdocument)
- [getMaxListeners](FetchableDocument.md#getmaxlisteners)
- [listenerCount](FetchableDocument.md#listenercount)
- [listeners](FetchableDocument.md#listeners)
- [off](FetchableDocument.md#off)
- [offStateUpdate](FetchableDocument.md#offstateupdate)
- [on](FetchableDocument.md#on)
- [onStateUpdate](FetchableDocument.md#onstateupdate)
- [once](FetchableDocument.md#once)
- [prependListener](FetchableDocument.md#prependlistener)
- [prependOnceListener](FetchableDocument.md#prependoncelistener)
- [rawListeners](FetchableDocument.md#rawlisteners)
- [read](FetchableDocument.md#read)
- [reload](FetchableDocument.md#reload)
- [removeAllListeners](FetchableDocument.md#removealllisteners)
- [removeListener](FetchableDocument.md#removelistener)
- [setError](FetchableDocument.md#seterror)
- [setMaxListeners](FetchableDocument.md#setmaxlisteners)
- [getEventListeners](FetchableDocument.md#geteventlisteners)
- [listenerCount](FetchableDocument.md#listenercount-1)
- [on](FetchableDocument.md#on-1)
- [once](FetchableDocument.md#once-1)
- [setMaxListeners](FetchableDocument.md#setmaxlisteners-1)

## Constructors

### constructor

• **new FetchableDocument**(`dependencies`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `dependencies` | [`FetchableDocumentDependencies`](../interfaces/FetchableDocumentDependencies.md) |
...
[lib/document/FetchableDocument.ts:17](https://github.com/o-development/ldo-solid-react/blob/29a7f21/lib/document/FetchableDocument.ts#L17)
...
• `Private` **dependencies**: [`FetchableDocumentDependencies`](../interfaces/FetchableDocumentDependencies.md)

#### Defined in

[lib/document/FetchableDocument.ts:15](https://github.com/o-development/ldo-solid-react/blob/29a7f21/lib/document/FetchableDocument.ts#L15)
...
▸ **addListener**(`eventName`, `listener`): [`FetchableDocument`](FetchableDocument.md)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](FetchableDocument.md#defaultmaxlisteners).
...
▸ **off**(`eventName`, `listener`): [`FetchableDocument`](FetchableDocument.md)
...
▸ **on**(`eventName`, `listener`): [`FetchableDocument`](FetchableDocument.md)
...
▸ **once**(`eventName`, `listener`): [`FetchableDocument`](FetchableDocument.md)
...
▸ **prependListener**(`eventName`, `listener`): [`FetchableDocument`](FetchableDocument.md)
...
▸ **prependOnceListener**(`eventName`, `listener`): [`FetchableDocument`](FetchableDocument.md)
...
▸ **removeAllListeners**(`event?`): [`FetchableDocument`](FetchableDocument.md)
...
▸ **removeListener**(`eventName`, `listener`): [`FetchableDocument`](FetchableDocument.md)
...
▸ **setMaxListeners**(`n`): [`FetchableDocument`](FetchableDocument.md)
